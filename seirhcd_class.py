...
#------------------------------------------------------------------------------------------------------------------
#------------------------------------------------------------------------------------------------------------------
values = [arange(1,5000,10), arange(1,5000,10), arange(1,5000,10), arange(1,5000,10), arange(1, 10, 0.1), arange(1,13,0.1), arange(1, 10, 0.1), arange(1, 10, 0.1), arange(1, 20, 0.1), arange(0.1, 3, 0.01), arange(0.01, 0.5, 0.01), arange(0.1, 0.6, 0.01)]
